<html style="padding:0px;">
    ...
    <body style="background-color: white;">
		...
		<div class="container-fluid row no-gutter">
			<?php if($mynav): ?>
			<div id="scalingnav" style="width:250px;min-width:250px; background-color: #2c3037;" class="clearfix col-xs-4"><?php echo $nav; ?></div>
			<div id="scalingcontent" class="row col-xs-8" style="padding-left: 15px;">

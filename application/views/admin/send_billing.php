...
<table width="100%">
	...
	<tr>
		...
		<td>
			<?php echo date('F j, Y',strtotime($billing_data['billing_date'])); ?>
		</td>
	</tr>
	<tr>
		<td>
		...
		<td>
			<?php echo date('F t, Y',strtotime($billing_data['billing_date'])); ?>
		</td>
	</tr>
	<tr>
		<td>
...
<div style='margin:10px; font-family: '?? ??', Arial,MS P????;  background-color:#4486f6;'>
